...
class Gurobi(SolverBase):
    ...
    def to_structured(self) -> dict:
        ...
        This makes ``Gurobi`` usable as the **source** of a cross-backend model exchange,
        e.g., to batch-solve subproblems built in Gurobi via a GPU backend such as
        ...
        for v in self.model.getVars():
            ...
            vars_.append({
                ...
                'vtype': 'I' if v.VType in (GRB.INTEGER, GRB.BINARY) else 'C',
                'obj': float(v.Obj),
            })
